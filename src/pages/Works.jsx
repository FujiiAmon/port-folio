...
import bppopt from "../assets/bpp-opt.png";
import mhs from "../assets/mhs.pdf";
    ...
    return (
        <div className="page-shell page-works">
            ...
            <SGrid>
                ...
                <WorkCard
                    src={bppopt}
                    link={"https://github.com/FujiiAmon/bpp"}
                    text={"bin packing problem"}
                    des={
                        "大学の専攻内容で取り組んだ。c言語で書いており、アルゴリズムとしてはfirst fit法とbest fit法という手法を用いている。"
                    }
                />
                <WorkCard
                    src={mhs}
                    link={"https://github.com/FujiiAmon/mhs"}
                    text={"卒業研究"}
                    des={
                        "卒業研究で取り組んだmhs問題についてのプログラム。c言語で書いている。"
                    }
                />
                <WorkCard
                    src={exawizards}
                ...
                <WorkCard
                    ...
                    text={"studicon"}
                    des={
                        "技育ハッカソンに出場して作成。2日間かけて4人で取り組んだ。生成AIでアイコンを作る&編集&アップロードする機能を開発。即席メンバーで各々が使える技術を採用し、Next.jsとpythonを使用。FastAPIとバックエンドのサポートを担当。"
                    }
                />
                <WorkCard
                ...
                <WorkCard
                    src={
                        "https://img.icons8.com/ios/100/confidential-stamp.png"
                    }
                    text={"インターンでの開発"}
                    des={
                        "守秘義務の関係で公開できないが、WEBアプリやネイティブアプリの開発に携わった。フロントエンドメインでバックエンドも多少担当した。仕様書作成なども行い、実務経験を積むことができて勉強になった。"
                    }
                />
            </SGrid>
